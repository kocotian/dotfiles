...
let s:cdFront = {'gui': '#D4D4D4', 'cterm': s:cterm05, 'cterm256': '15'}
...
let s:cdGold = {'gui': '#BBBBBB', 'cterm': s:cterm03, 'cterm256': '03'}
let s:cdPopupFront = {'gui': '#BBBBBB', 'cterm': s:cterm03, 'cterm256': '07'}
...
let s:cdDiffGreenLight = {'gui': '#FFC107', 'cterm': s:cterm09, 'cterm256': '58'}
...
let s:cdViolet = {'gui': '#646695', 'cterm': s:cterm04, 'cterm256': '05'}
...
call <sid>hi('CursorLineNr', s:cdGold, s:cdBack, 'none', {})
call <sid>hi('Marker', s:cdGray, s:cdNone, 'none', {})
...
call <sid>hi('Title', s:cdOrange, s:cdNone, 'bold', {})
